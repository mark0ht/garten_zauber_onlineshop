  ...
  <div class="min-h-screen bg-gray-100 flex flex-col items-center">
    ...
    <main class="p-6 max-w-4xl w-full">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div v-for="product in products" :key="product.id" class="p-4 bg-white rounded-lg shadow-md hover:shadow-lg">
          ...
          <button @click="addToCart(product)" class="bg-blue-500 hover:bg-green-600 text-white px-4 py-2 rounded">
